...
nnoremap ,ff :FufFile   " search files
nnoremap ,2 :NERDTreeToggle
nnoremap ,1 :TagbarToggle
nnoremap ,w :w
nnoremap ,rv :source $MYVIMRC
nnoremap ,ev :e $MYVIMRC
nnoremap ,sp :setlocal spell!
nnoremap ,sh sj
nnoremap ,sv vl
map 4 $i<Right>
map B i//************************************************************kkk4   
...
noremap <SNR>35_Visual y:call twitvim#post_twitter(@", 0)
...
silent only
silent tabonly
cd /mnt/c/Users/James/Desktop/Personal/TrackerJohn
...
argglobal
%argdel
$argadd tracker_john.go
edit dashboard_files/script.js
...
wincmd w
argglobal
if bufexists("dashboard.html") | buffer dashboard.html | else | edit dashboard.html | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 136 - ((10 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
136
...
wincmd w
argglobal
if bufexists("tracker_john.go") | buffer tracker_john.go | else | edit tracker_john.go | endif
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 190 - ((22 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
190
...
exe 'vert 4resize ' . ((&columns * 83 + 84) / 168)
tabnext 1
badd +0 tracker_john.go
badd +0 ind
badd +0 dashboard.html
badd +0 dashboard_files/script.js
